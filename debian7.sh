...
# download
cd /usr/bin
wget -O menu "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/menu.sh"
wget -O banner-edit "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/banner-edit.sh"
wget -O user-new "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/user-new.sh"
wget -O create-trial "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/user-trial.sh"
wget -O delete-user "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/user-del.sh"
wget -O user-login "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/user-login.sh"
wget -O user-list "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/user-list.sh"
wget -O resvis "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/resvis.sh"
wget -O speedtest "http://x-mvst.cf/ld/Debian7/speedtest_cli.py"
wget -O info "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/info.sh"
wget -O mem-info "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/mrtg-mem.sh"
wget -O about-team "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/about.sh"
wget -O limit-login "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/user-limit.sh"
wget -O create-ocs "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/create-ocs.sh"
wget -O dropmon "https://raw.githubusercontent.com/kangrio/ssh-vpn-for-debian7/master/dropmon.sh"
...
# info
clear
echo -e "\e[36;1m Autoscript Include: สร้างโดย KangRio" | tee log-install.txt
...
echo -e "\e[35;1m menu          (พิมพ์ menu เพื่อเรียกใช้คำสั่งทั้งหมด)"  | tee -a log-install.txt
echo -e "\e[35;1m banner-edit   (เปลี่ยน banner login)"  | tee -a log-install.txt
echo -e "\e[35;1m user-new 	(สร้างบัญชี SSH)"  | tee -a log-install.txt
echo -e "\e[35;1m create-trial  (สร้างบัญชีทดลอง)"  | tee -a log-install.txt
echo -e "\e[35;1m delete-user   (ลบบัญชี SSH)"  | tee -a log-install.txt
echo -e "\e[38;1m user-login    (เช็คผู้ใช้งานอยู่ User Login)"  | tee -a log-install.txt
echo -e "\e[38;1m user-list     (เช็ค ผู้ใช้ SSH)"  | tee -a log-install.txt
echo -e "\e[38;1m resvis        (รีสตาท บริการ dropbear, webmin, squid3, openvpn dan ssh)"  | tee -a log-install.txt
echo -e "\e[34;1m reboot        (รีบูต VPS)"  | tee -a log-install.txt
echo -e "\e[34;1m speedtest     (เช็คความเร็ว VPS)"  | tee -a log-install.txt
echo -e "\e[34;1m info          (ข้อมูลระบบ)"  | tee -a log-install.txt
echo -e "\e[34;1m mem-info      (ข้อมูล memory)" | tee -a log-install.txt
echo -e "\e[34;1m limit-login	(ปิดใช้งานหลายเครื่อง)" | tee -a log-install.txt
echo -e "\e[34;1m about-team    (ข้อมูลของ script)"  | tee -a log-install.txt
...
echo -e ""  | tee -a log-install.txt
echo -e "\e[35;1m =[อื่นๆ]="  | tee -a log-install.txt
echo -e "\e[35;1m =[----------]="  | tee -a log-install.txt
echo -e "\e[36;1m =[Webmin       : http://$MYIP:10000/]="  | tee -a log-install.txt
echo -e "\e[36;1m =[Timezone     : Asia/Bangkok (GMT +7)]="  | tee -a log-install.txt
echo -e "\e[36;1m =[IPv6         : [Off]]="  | tee -a log-install.txt
echo -e "\e[36;1m =[Ddos Flate   : [On]]="  | tee -a log-install.txt
echo -e "\e[36;1m =[บล็อก Torrent: [On]]="  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo -e "\e[37;1m =[สร้างโดย KangRio]="  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo -e "\e[37;1m =[Log การติดตั้ง --> /root/log-install.txt]="  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo -e "\e[33;1m =[VPS รีบูตอัตโนมัติเวลาเที่ยงคืน ]="  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo -e "=[===========================================]="  | tee -a log-install.txt
